...
module Body = struct
  module Node = struct
    ...
    module Parameter = struct
      type t = Head.Node.Parameter.t
      let  t = Head.Node.Parameter.t
      
      let name = field t Text 0l
    end
    module NestedNode = struct
      type t = Head.Node.NestedNode.t
      let  t = Head.Node.NestedNode.t
      
      let name = field t Text 0l
      let id = field t UInt64 0l
    end
    module SourceInfo = struct
      type t = Head.Node.SourceInfo.t
      let  t = Head.Node.SourceInfo.t
      module Member = struct
        type t = Head.Node.SourceInfo.Member.t
        let  t = Head.Node.SourceInfo.Member.t
      ...
      let id = field t UInt64 0l
      let docComment = field t Text 0l
      let members = field t (List (Ptr Head.Node.SourceInfo.Member.t)) 1l
    end
    module Struct = struct
      type t = Head.Node.Struct.t
      let  t = Head.Node.Struct.t
      
      let dataWordCount = field t UInt16 112l
      let pointerCount = field t UInt16 192l
      let preferredListEncoding = field t Head.ElementSize.t 208l
      let isGroup = field t Bool 224l
      let discriminantCount = field t UInt16 240l
      let discriminantOffset = field t UInt32 256l
      let fields = field t (List (Ptr Head.Field.t)) 3l
    end
    module Enum = struct
      type t = Head.Node.Enum.t
      let  t = Head.Node.Enum.t
      
      let enumerants = field t (List (Ptr Head.Enumerant.t)) 3l
    end
    module Interface = struct
      type t = Head.Node.Interface.t
      let  t = Head.Node.Interface.t
      
      let methods = field t (List (Ptr Head.Method.t)) 3l
      let superclasses = field t (List (Ptr Head.Superclass.t)) 4l
    end
    module Const = struct
      type t = Head.Node.Const.t
      let  t = Head.Node.Const.t
      
      let type_ = field t (Ptr Head.Type.t) 3l
      let value = field t (Ptr Head.Value.t) 4l
    end
    module Annotation = struct
      type t = Head.Node.Annotation.t
      let  t = Head.Node.Annotation.t
    ...
    type union =
      | File
      | Struct of Head.Node.Struct.t s c
      | Enum of Head.Node.Enum.t s c
      | Interface of Head.Node.Interface.t s c
      | Const of Head.Node.Const.t s c
      | Annotation of Head.Node.Annotation.t s c
    let union =
      let union_tag = field t UInt16 96l in
      let f c =
        match c => union_tag with
          | 0 -> File
          | 1 -> Struct (c => (group t (Ptr Head.Node.Struct.t)))
          | 2 -> Enum (c => (group t (Ptr Head.Node.Enum.t)))
          | 3 -> Interface (c => (group t (Ptr Head.Node.Interface.t)))
          | 4 -> Const (c => (group t (Ptr Head.Node.Const.t)))
          | 5 -> Annotation (c => (group t (Ptr Head.Node.Annotation.t)))
          | n -> raise (Capnptk.OrdinalError n)
      in
      let g b = function
        | File -> b |> set union_tag 0;
        | Struct v -> b |> set (group t (Ptr Head.Node.Struct.t)) v |> set union_tag 1
        | Enum v -> b |> set (group t (Ptr Head.Node.Enum.t)) v |> set union_tag 2
        | Interface v -> b |> set (group t (Ptr Head.Node.Interface.t)) v |> set union_tag 3
        | Const v -> b |> set (group t (Ptr Head.Node.Const.t)) v |> set union_tag 4
        | Annotation v -> b |> set (group t (Ptr Head.Node.Annotation.t)) v |> set union_tag 5
      in ug f g
    ...
    let nestedNodes = field t (List (Ptr Head.Node.NestedNode.t)) 1l
    let annotations = field t (List (Ptr Head.Annotation.t)) 2l
    let parameters = field t (List (Ptr Head.Node.Parameter.t)) 5l
  ...
  module Field = struct
    ...
    module Slot = struct
      type t = Head.Field.Slot.t
      let  t = Head.Field.Slot.t
      
      let offset = field t UInt32 32l
      let type_ = field t (Ptr Head.Type.t) 2l
      let defaultValue = field t (Ptr Head.Value.t) 3l
      let hadExplicitDefault = field t Bool 128l
    end
    module Group = struct
      type t = Head.Field.Group.t
      let  t = Head.Field.Group.t
      
      let typeId = field t UInt64 128l
    end
    module Ordinal = struct
      type t = Head.Field.Ordinal.t
      let  t = Head.Field.Ordinal.t
    ...
    type union =
      | Slot of Head.Field.Slot.t s c
      | Group of Head.Field.Group.t s c
    let union =
      let union_tag = field t UInt16 64l in
      let f c =
        match c => union_tag with
          | 0 -> Slot (c => (group t (Ptr Head.Field.Slot.t)))
          | 1 -> Group (c => (group t (Ptr Head.Field.Group.t)))
          | n -> raise (Capnptk.OrdinalError n)
      in
      let g b = function
        | Slot v -> b |> set (group t (Ptr Head.Field.Slot.t)) v |> set union_tag 0
        | Group v -> b |> set (group t (Ptr Head.Field.Group.t)) v |> set union_tag 1
      in ug f g
    
    let name = field t Text 0l
    let codeOrder = field t UInt16 0l
    let annotations = field t (List (Ptr Head.Annotation.t)) 1l
    let discriminantValue = field t UInt16 ~default:(65535) 16l
    let ordinal = group t (Ptr Head.Field.Ordinal.t)
  end
  module Enumerant = struct
    type t = Head.Enumerant.t
    let  t = Head.Enumerant.t
  ...
  module Superclass = struct
    type t = Head.Superclass.t
    let  t = Head.Superclass.t
    
    let id = field t UInt64 0l
    let brand = field t (Ptr Head.Brand.t) 0l
  end
  module Method = struct
    type t = Head.Method.t
    let  t = Head.Method.t
    ...
    let annotations = field t (List (Ptr Head.Annotation.t)) 1l
    let paramBrand = field t (Ptr Head.Brand.t) 2l
    let resultBrand = field t (Ptr Head.Brand.t) 3l
    let implicitParameters = field t (List (Ptr Head.Node.Parameter.t)) 4l
  end
  module Type = struct
    type t = Head.Type.t
    let  t = Head.Type.t
    module List = struct
      type t = Head.Type.List.t
      let  t = Head.Type.List.t
      
      let elementType = field t (Ptr Head.Type.t) 0l
    end
    module Enum = struct
      type t = Head.Type.Enum.t
      let  t = Head.Type.Enum.t
      
      let typeId = field t UInt64 64l
      let brand = field t (Ptr Head.Brand.t) 0l
    end
    module Struct = struct
      type t = Head.Type.Struct.t
      let  t = Head.Type.Struct.t
      
      let typeId = field t UInt64 64l
      let brand = field t (Ptr Head.Brand.t) 0l
    end
    module Interface = struct
      type t = Head.Type.Interface.t
      let  t = Head.Type.Interface.t
      
      let typeId = field t UInt64 64l
      let brand = field t (Ptr Head.Brand.t) 0l
    end
    module AnyPointer = struct
      type t = Head.Type.AnyPointer.t
      let  t = Head.Type.AnyPointer.t
      module Unconstrained = struct
        type t = Head.Type.AnyPointer.Unconstrained.t
        let  t = Head.Type.AnyPointer.Unconstrained.t
      ...
      module Parameter = struct
        type t = Head.Type.AnyPointer.Parameter.t
        let  t = Head.Type.AnyPointer.Parameter.t
        
        let scopeId = field t UInt64 128l
        let parameterIndex = field t UInt16 80l
      end
      module ImplicitMethodParameter = struct
        type t = Head.Type.AnyPointer.ImplicitMethodParameter.t
        let  t = Head.Type.AnyPointer.ImplicitMethodParameter.t
        
        let parameterIndex = field t UInt16 80l
      end
      
      type union =
        | Unconstrained of Head.Type.AnyPointer.Unconstrained.t s c
        | Parameter of Head.Type.AnyPointer.Parameter.t s c
        | ImplicitMethodParameter of Head.Type.AnyPointer.ImplicitMethodParameter.t s c
      let union =
        let union_tag = field t UInt16 64l in
        let f c =
          match c => union_tag with
            | 0 -> Unconstrained (c => (group t (Ptr Head.Type.AnyPointer.Unconstrained.t)))
            | 1 -> Parameter (c => (group t (Ptr Head.Type.AnyPointer.Parameter.t)))
            | 2 -> ImplicitMethodParameter (c => (group t (Ptr Head.Type.AnyPointer.ImplicitMethodParameter.t)))
            | n -> raise (Capnptk.OrdinalError n)
        in
        let g b = function
          | Unconstrained v -> b |> set (group t (Ptr Head.Type.AnyPointer.Unconstrained.t)) v |> set union_tag 0
          | Parameter v -> b |> set (group t (Ptr Head.Type.AnyPointer.Parameter.t)) v |> set union_tag 1
          | ImplicitMethodParameter v -> b |> set (group t (Ptr Head.Type.AnyPointer.ImplicitMethodParameter.t)) v |> set union_tag 2
        in ug f g
    ...
    type union =
      ...
      | Text
      | Data
      | List of Head.Type.List.t s c
      | Enum of Head.Type.Enum.t s c
      | Struct of Head.Type.Struct.t s c
      | Interface of Head.Type.Interface.t s c
      | AnyPointer of Head.Type.AnyPointer.t s c
    let union =
      ...
      let f c =
        match c => union_tag with
          ...
          | 12 -> Text
          | 13 -> Data
          | 14 -> List (c => (group t (Ptr Head.Type.List.t)))
          | 15 -> Enum (c => (group t (Ptr Head.Type.Enum.t)))
          | 16 -> Struct (c => (group t (Ptr Head.Type.Struct.t)))
          | 17 -> Interface (c => (group t (Ptr Head.Type.Interface.t)))
          | 18 -> AnyPointer (c => (group t (Ptr Head.Type.AnyPointer.t)))
          | n -> raise (Capnptk.OrdinalError n)
      in
      let g b = function
        ...
        | List v -> b |> set (group t (Ptr Head.Type.List.t)) v |> set union_tag 14
        | Enum v -> b |> set (group t (Ptr Head.Type.Enum.t)) v |> set union_tag 15
        | Struct v -> b |> set (group t (Ptr Head.Type.Struct.t)) v |> set union_tag 16
        | Interface v -> b |> set (group t (Ptr Head.Type.Interface.t)) v |> set union_tag 17
        | AnyPointer v -> b |> set (group t (Ptr Head.Type.AnyPointer.t)) v |> set union_tag 18
      in ug f g
  ...
  module Brand = struct
    ...
    let  t = Head.Brand.t
    module Scope = struct
      type t = Head.Brand.Scope.t
      let  t = Head.Brand.Scope.t
      
      type union =
        | Bind of Head.Brand.Binding.t s c array
        | Inherit
      let union =
        let union_tag = field t UInt16 64l in
        let f c =
          match c => union_tag with
            | 0 -> Bind (c => (field t (List (Ptr Head.Brand.Binding.t)) 0l))
            | 1 -> Inherit
            | n -> raise (Capnptk.OrdinalError n)
        in
        let g b = function
          | Bind v -> b |> set (field t (List (Ptr Head.Brand.Binding.t)) 0l) v |> set union_tag 0
    ...
    module Binding = struct
      type t = Head.Brand.Binding.t
      let  t = Head.Brand.Binding.t
      
      type union =
        | Unbound
        | Type of Head.Type.t s c
      let union =
        let union_tag = field t UInt16 0l in
        let f c =
          match c => union_tag with
            | 0 -> Unbound
            | 1 -> Type (c => (field t (Ptr Head.Type.t) 0l))
            | n -> raise (Capnptk.OrdinalError n)
        in
        let g b = function
          | Unbound -> b |> set union_tag 0;
          | Type v -> b |> set (field t (Ptr Head.Type.t) 0l) v |> set union_tag 1
        in ug f g
      
    end
    
    let scopes = field t (List (Ptr Head.Brand.Scope.t)) 0l
  end
  module Value = struct
    type t = Head.Value.t
    let  t = Head.Value.t
  ...
  module Annotation = struct
    type t = Head.Annotation.t
    let  t = Head.Annotation.t
    
    let id = field t UInt64 0l
    let value = field t (Ptr Head.Value.t) 0l
    let brand = field t (Ptr Head.Brand.t) 1l
  end
  module ElementSize = struct
    type t = Head.ElementSize.t
    let  t = Head.ElementSize.t
  end
  module CapnpVersion = struct
    type t = Head.CapnpVersion.t
    let  t = Head.CapnpVersion.t
  ...
  module CodeGeneratorRequest = struct
    type t = Head.CodeGeneratorRequest.t
    let  t = Head.CodeGeneratorRequest.t
    module RequestedFile = struct
      type t = Head.CodeGeneratorRequest.RequestedFile.t
      let  t = Head.CodeGeneratorRequest.RequestedFile.t
      module Import = struct
        type t = Head.CodeGeneratorRequest.RequestedFile.Import.t
        let  t = Head.CodeGeneratorRequest.RequestedFile.Import.t
      ...
      let imports = field t (List (Ptr Head.CodeGeneratorRequest.RequestedFile.Import.t)) 1l
    end
    
    let nodes = field t (List (Ptr Head.Node.t)) 0l
    let requestedFiles = field t (List (Ptr Head.CodeGeneratorRequest.RequestedFile.t)) 1l
    let capnpVersion = field t (Ptr Head.CapnpVersion.t) 2l
    let sourceInfo = field t (List (Ptr Head.Node.SourceInfo.t)) 3l
  end
end
